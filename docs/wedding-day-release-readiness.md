...
- **Calendar** — correctly *not* duplicated on the dashboard itself. (A former "Booking Schedule" link to `/calendar/booking/{eventId}` was retired; day-of schedule context lives on Timeline and the venue Calendar.)
