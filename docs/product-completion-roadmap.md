...
**Program 2 — two adopted design principles (2026-07-07), not yet implemented:**
...
Both principles deserve the same "design before code" pass TR-M1 got (`docs/stripe-payment-architecture.md`) once Program 1 closes and Program 2 starts in earnest. Not started this pass — captured here as adopted direction, not yet designed.
