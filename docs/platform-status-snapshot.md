...
| Floor Plans (incl. Vendor Event Assets) | ✅ Complete + Phase 2/3 Document SoR + Migration Center import | Phase 1 gates. Phase 2: background_document_id Document SoR + PDF page-1 derivative. Phase 3: Migration Center batch import (multi-file/ZIP), Space/Event/general scopes, ambiguous → needs_review. |
