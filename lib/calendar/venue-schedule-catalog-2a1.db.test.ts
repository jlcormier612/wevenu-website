/**
 * Calendar Slice 2A.1 — live DB checks for catalog seed, covering, and FK.
 */
...
const CASES = resolve("lib/calendar/venue-schedule-catalog-2a1.db.sql");
...
describe("venue_schedule_item_types live database", () => {
  it("seeds builtins, backfills occupancy, covers Events by snapshot, blocks cross-venue FK", (t: TestContext) => {
    if (!localDbAvailable()) {
