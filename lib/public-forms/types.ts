...
export type PublicFormQrSummary = {
  id: string;
  name: string;
  code: string;
...
export type PublicFormLeadSummary = {
  id: string;
  firstName: string;
  lastName: string;
  email: string | null;
...
export type PublicFormUnavailableState = {
  status: PublicFormStatus | "unknown";
  publicTitle: string;
  venue: PublicFormVenueBrand | null;
};
