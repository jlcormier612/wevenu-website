...
export const MERGE_FIELDS: MergeFieldMeta[] = [
  ...
  { key: "first_name", label: "First Name", description: "Primary contact's first name" },
  { key: "last_name", label: "Last Name", description: "Primary contact's last name" },
  { key: "full_name", label: "Full Name", description: "Primary contact's first and last name" },
