...
export const SETUP_GUIDES: readonly SetupGuide[] = [
  ...
  guide({
    ...
    intro: "Hello to Cheers is the place you send messages to couples and vendors. The four send choices are Email, SMS, Portal message, and Internal note. Email is set up for Hello to Cheers as a platform. Texting is enabled per venue in Settings → Communications. The compose box will tell you whether each channel is ready before you send.",
    ...
    troubleshooting: [
      ...
      "If SMS shows as not ready, open Settings → Communications → Text messaging (or the Enable text messaging link from Inbox / Communication Health) and complete setup for your venue. Portal message and Internal note still work.",
