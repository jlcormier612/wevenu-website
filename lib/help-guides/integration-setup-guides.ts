...
export const INTEGRATION_SETUP_GUIDES: readonly IntegrationSetupGuide[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      {
        number: 7,
        title: "Choose and enable the Lead Ads forms",
        ...
        lookFor: "The forms you selected should appear under Connected forms with an enabled switch. Only after at least one form is enabled is the Lead Ads connection ready to receive leads.",
        dontDo: "Do not stop after selecting the Facebook Page. A Page can be connected while zero forms are enabled, and in that state Lead Ads submissions will not flow into Hello to Cheers. Do not enable a form that belongs to another campaign, another business, or an old test unless you want those submissions imported too.",
        tip: "This is the most important Facebook checkpoint: Page connected does not equal Lead Ads ready. You need at least one enabled form.",
      },
      {
        number: 8,
        title: "Instagram: no separate Hello to Cheers connection",
        doThis: "You do not connect Instagram separately inside Hello to Cheers. If your Meta advertising uses Instagram placements, keep the venue's Instagram account associated with the same Meta business/Page setup you use for the Lead Ad.",
      ...
      {
        number: 9,
        title: "Confirm the connection is actually ready",
        doThis: "Back in Settings → Financials & Integrations, review Facebook / Instagram Lead Ads.",
        lookFor: "You should see Connected, the selected Page, and at least one enabled form under Connected forms. The connection is ready for new leads only when that form is enabled.",
        dontDo: "Do not treat a green Connected badge by itself as proof that Lead Ads are ready if no connected forms are shown. If no form is enabled, return to the form-selection step before relying on this integration.",
      },
    ],
    completion:
      "You're connected and ready for Lead Ads! Your selected Page has at least one enabled form, so new submissions from those forms can flow into Hello to Cheers as Leads. If you use Instagram placements, no separate Instagram connection is required.",
    troubleshooting: [
      ...
      "If the Page is connected but no Connected forms are shown, the setup is not complete. Leads from Lead Ads will not arrive until at least one form is selected and enabled.",
