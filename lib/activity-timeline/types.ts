 ...
 * vendor assignments, automation enrollments) plus Conversation activity
 * collapsed into "Conversation started"/"Conversation resumed" narrative
 * markers — never one row per message. See get_relationship_activity_timeline RPC.
 */
export type ActivityTimelineSource =
  | "lead" | "client" | "event" | "payment" | "invoice" | "request"
  | "contract" | "timeline" | "guests" | "vendor" | "conversation" | "automation";
