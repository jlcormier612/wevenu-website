...
> = {
  ...
  "bring-your-business": {
    ...
    whatHappensNext: "Next, we'll check your packages, Offerings catalog, and inventory.",
  },
  "your-offerings": {
    title: "Your offerings",
    description: "Packages, Offerings, and Inventory — what you sell, provide, and own.",
    whatWereDoing: "Check your packages, Offerings catalog, and physical inventory.",
    whyItMatters: "Packages are what couples buy. Offerings are what you provide on an Event Order. Inventory is physical stock.",
