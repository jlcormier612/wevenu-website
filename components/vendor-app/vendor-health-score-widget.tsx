...
type HealthTier = VendorHealthScore["tier"];
  ...
  return (
    <div className="space-y-1">
      <div className="flex items-center justify-between">
        ...
        <span className="text-[11px] font-semibold text-heading">{score}<span className="text-muted-foreground font-normal">/{weight}</span></span>
      </div>
...
export function VendorHealthScoreWidget({ health }: { health: VendorHealthScore }) {
      ...
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h2 className="font-heading text-sm font-semibold text-heading">Business Health</h2>
          </div>
      ...
      <CardContent className="pt-0 space-y-4">
        ...
        {health.luvTip && (
          <div className="border-t border-pink-200/40 pt-3">
            <p className="text-xs text-pink-600 dark:text-pink-400">{health.luvTip}</p>
          </div>
        )}
      </CardContent>
    </Card>
