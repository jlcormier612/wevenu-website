...
import { MapPin, Phone, Globe, HelpCircle, Users, Car, CloudRain } from "lucide-react";
 ...
 * Guide, through get_vendor_handbook(s). Shared by both the top-level
 * "Venue Information" nav destination and the per-event workspace's own
 * Venue Information tab — same component, different data-fetch scope.
 */
  ...
  return (
    <div className="space-y-4">
      ...
      {!info ? (
        ...
        <>
          {info.parkingInfo && <Section icon={Car} title="Parking & Load-in">{info.parkingInfo}</Section>}
