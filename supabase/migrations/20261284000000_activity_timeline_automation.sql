-- Automation P0: include sequence enrollment lifecycle in the relationship
-- activity timeline (enrolled / completed / exited_* / cancelled).
-- Replaces get_relationship_activity_timeline; no new history table.
    ...
    coalesce(
      (
        ...
        all_events as (
          ...
          -- Automation (sequence) enrollment lifecycle — enrolled always;
          -- terminal statuses also emit a second event at exited_at.
          union all
