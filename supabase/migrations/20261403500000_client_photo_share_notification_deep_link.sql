-- Point couple-photo-share notifications at the Client edit screen where
-- the Photo section lives, so the venue can view/use the shared photo
-- without searching.
...
begin
  ...
  if v_notify then
    ...
    -- Client edit hosts the Photo section (venue upload + shared couple photo).
