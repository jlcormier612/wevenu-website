-- Brochure authored photography + curated presentation style.
-- Photo URLs reference existing venue storage (uploads bucket). Removing a
-- photo from a brochure does not delete the underlying object.
