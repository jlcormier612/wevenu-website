-- ============================================================================
-- Corrective migration — get_event_timeline_merged's two concatenated
-- entry blocks (venue live items || client's latest submitted snapshot)
-- were each missing an ORDER BY inside their jsonb_agg, so the merged
-- result had no reliable chronological order. Found before any report or
-- live validation; fixed here rather than editing the already-applied
-- 20261029040000 migration, per this project's standing migration
-- discipline.
-- ============================================================================
