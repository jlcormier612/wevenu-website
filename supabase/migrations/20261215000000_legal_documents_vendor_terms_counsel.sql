-- Replace Vendor Terms with counsel draft (immutable new active version).
-- Effective date unchanged: 2026-07-15.
...
set
  ...
  updated_at = now()
where document_type = 'vendor_end_user_terms'
  and version is distinct from '2026-07-15.2'
  and is_active = true;
