-- Help & Guides final content + IA (31 articles).
-- Replaces all prior success_library_articles with the verified final set.
-- Idempotent: delete + insert of the final slug set.

delete from public.success_library_articles;
...
It's to get your venue ready to work. You can refine the rest as you go.$body$,
  '',
  '',
  '',
  '[]'::jsonb,
...
Hello to Cheers is designed so you can build on it as your venue works.$body$,
  '',
  '',
  '',
  '[]'::jsonb,
...
Think of your venue branding as **the way Hello to Cheers presents your venue to your clients**, rather than a replacement for the Hello to Cheers workspace your team uses every day.$body$,
  '',
  '',
  '',
  '[]'::jsonb,
...
insert into public.success_library_articles
  (slug, title, goal_category, why_it_matters, when_to_use, best_practices, common_mistakes, related_features, linked_gap_keys, status)
values (
  'how-do-i-set-my-tour-availability',
  'How Do I Set My Tour Availability?',
  'Your Venue',
...
Different venues handle tours differently. Your schedule should reflect the way your venue actually works.$body$,
  '',
  '',
  '',
  '[]'::jsonb,
...
**Where is this relationship in the sales process?**$body$,
  '',
  '',
  '',
  '[]'::jsonb,
...
Your Pipeline should feel like **your sales process**, while still giving Hello to Cheers the information it needs to work correctly.$body$,
  '',
  '',
  '',
  '[]'::jsonb,
...
Automations should save you work without taking control away from you.$body$,
  '',
  '',
  '',
  '[]'::jsonb,
...
Contracts and payments are separate parts of the relationship, and Hello to Cheers keeps those records distinct so you can see what has actually happened.$body$,
  '',
  '',
  '',
  '[]'::jsonb,
...
insert into public.success_library_articles
  (slug, title, goal_category, why_it_matters, when_to_use, best_practices, common_mistakes, related_features, linked_gap_keys, status)
values (
  'what-is-the-difference-between-task-center-and-requests',
  'What Is the Difference Between Task Center and Requests?',
...
That separation keeps each part of Hello to Cheers useful instead of making one giant list of everything happening in your venue.$body$,
  '',
  '',
  '',
  '[]'::jsonb,
...
insert into public.success_library_articles
  (slug, title, goal_category, why_it_matters, when_to_use, best_practices, common_mistakes, related_features, linked_gap_keys, status)
values (
  'what-does-event-readiness-mean',
  'What Does Event Readiness Mean?',
  'Working With Clients',
...
Contracts and payments are related, but they are separate records in Hello to Cheers.$body$,
  '',
  '',
  '',
  '[]'::jsonb,
...
Each signer completes their own signature rather than sharing one signature between them.$body$,
  '',
  '',
  '',
  '[]'::jsonb,
...
Your venue's payment settings determine whether online payment is available to your clients.$body$,
  '',
  '',
  '',
  '[]'::jsonb,
...
insert into public.success_library_articles
  (slug, title, goal_category, why_it_matters, when_to_use, best_practices, common_mistakes, related_features, linked_gap_keys, status)
values (
  'what-do-draft-sent-paid-and-void-mean-on-an-invoice',
  'What Do Draft, Sent, Paid, and Void Mean on an Invoice?',
  'Contracts & Payments',
...
If you need to understand what happened with a particular client's invoice or payment, look at that client's Financials.$body$,
  '',
  '',
  '',
  '[]'::jsonb,
...
insert into public.success_library_articles
  (slug, title, goal_category, why_it_matters, when_to_use, best_practices, common_mistakes, related_features, linked_gap_keys, status)
values (
  'whats-the-difference-between-a-package-payment-schedule-and-payment',
  'What''s the Difference Between a Package, Payment Schedule, and Payment?',
  'Contracts & Payments',
...
That distinction matters because changing a reusable Library definition should not silently rewrite something your venue has already committed to a client.$body$,
  '',
  '',
  '',
  '[]'::jsonb,
...
That distinction keeps your reusable catalog separate from the specific commitments and choices for a particular client.$body$,
  '',
  '',
  '',
  '[]'::jsonb,
...
Start with the objects you need, place them where they belong, and use the additional controls when you need more precision.$body$,
  '',
  '',
  '',
  '[]'::jsonb,
...
For complicated floor plans, it can also help to work with smaller groups of objects instead of trying to select everything at once.$body$,
  '',
  '',
  '',
  '[]'::jsonb,
...
insert into public.success_library_articles
  (slug, title, goal_category, why_it_matters, when_to_use, best_practices, common_mistakes, related_features, linked_gap_keys, status)
values (
  'what-are-the-three-planning-questionnaires',
  'What Are the Three Planning Questionnaires?',
  'Planning the Event',
...
The event has its own working version and its own answers.$body$,
  '',
  '',
  '',
  '[]'::jsonb,
...
Use the event's questionnaire for the actual client's answers.$body$,
  '',
  '',
  '',
  '[]'::jsonb,
...
If you're looking for the client's complete response, go back to the questionnaire rather than assuming every answer has been copied into another part of the event.$body$,
  '',
  '',
  '',
  '[]'::jsonb,
...
insert into public.success_library_articles
  (slug, title, goal_category, why_it_matters, when_to_use, best_practices, common_mistakes, related_features, linked_gap_keys, status)
values (
  'how-do-i-create-a-timeline-from-a-template',
  'How Do I Create a Timeline From a Template?',
  'Planning the Event',
...
Once the template is applied, work with the event's Timeline as the real schedule for that client.$body$,
  '',
  '',
  '',
  '[]'::jsonb,
...
insert into public.success_library_articles
  (slug, title, goal_category, why_it_matters, when_to_use, best_practices, common_mistakes, related_features, linked_gap_keys, status)
values (
  'client-planning-vs-venue-planning-whats-the-difference',
  'Client Planning vs. Venue Planning: What''s the Difference?',
  'Planning the Event',
...
**Client Planning = what you want the client to participate in.**$body$,
  '',
  '',
  '',
  '[]'::jsonb,
...
That distinction is important because your template describes the way your venue normally works, while the event contains the actual work and dates for this particular client.$body$,
  '',
  '',
  '',
  '[]'::jsonb,
...
This keeps the Calendar from becoming a second task list full of noise.$body$,
  '',
  '',
  '',
  '[]'::jsonb,
...
insert into public.success_library_articles
  (slug, title, goal_category, why_it_matters, when_to_use, best_practices, common_mistakes, related_features, linked_gap_keys, status)
values (
  'how-do-vendors-work-in-hello-to-cheers',
  'How Do Vendors Work in Hello to Cheers?',
  'Vendors',
...
Once a vendor is assigned to an event, the event workspace can show the information that matters for that event without exposing unrelated information from other events.$body$,
  '',
  '',
  '',
  '[]'::jsonb,
...
insert into public.success_library_articles
  (slug, title, goal_category, why_it_matters, when_to_use, best_practices, common_mistakes, related_features, linked_gap_keys, status)
values (
  'what-is-the-day-of-sheet-and-how-do-i-get-one',
  'What Is the Day-of Sheet, and How Do I Get One?',
  'Event Day',
...
It is designed to give your team one practical document they can use on the day without having to move through the entire event workspace.$body$,
  '',
  '',
  '',
  '[]'::jsonb,
...
insert into public.success_library_articles
  (slug, title, goal_category, why_it_matters, when_to_use, best_practices, common_mistakes, related_features, linked_gap_keys, status)
values (
  'what-is-the-wedding-day-dashboard',
  'What Is the Wedding Day Dashboard?',
  'Event Day',
...
The dashboard is designed for the information and actions your team needs while the event is actually happening.$body$,
  '',
  '',
  '',
  '[]'::jsonb,
...
Then click into the underlying records when you need to understand a specific client or event.$body$,
  '',
  '',
  '',
  '[]'::jsonb,
...
insert into public.success_library_articles
  (slug, title, goal_category, why_it_matters, when_to_use, best_practices, common_mistakes, related_features, linked_gap_keys, status)
values (
  'whats-the-difference-between-reports-and-saved-reports',
  'What''s the Difference Between Reports and Saved Reports?',
  'Reports',
...
If you find a report configuration you use regularly, save it so you don't have to rebuild the same view each time.$body$,
  '',
  '',
  '',
  '[]'::jsonb,
...
The event has moved into its next stage; its history still matters.$body$,
  '',
  '',
  '',
  '[]'::jsonb,
