-- Include documents.created_at in get_vendor_event_detail so the vendor
-- event Overview activity feed can show real document-share timestamps
-- instead of epoch zero (Dec 31, 1969 / Jan 1, 1970).
