...
export async function GET(request: Request) {
  ...
  try {
    ...
    console.log(`[cron] automation processed: ${result.executed} executed, ${result.skipped} skipped, ${result.failed} failed | system guarantees: ${result.systemGuarantees.applied} applied | sequence enrollments: ${result.sequenceEnrollments.enrolled} enrolled, ${result.sequenceEnrollments.scanned} scanned`);
