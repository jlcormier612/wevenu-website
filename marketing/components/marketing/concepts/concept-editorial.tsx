    ...
    <div className="pb-24">
      ...
      <section className="relative min-h-[92vh]">
        ...
        <div className="relative z-10 mx-auto flex min-h-[92vh] max-w-5xl flex-col justify-end px-6 pb-16 pt-40 text-[var(--true-white)]">
          ...
          <h1 className="mt-4 font-heading text-[3.36rem] font-medium leading-[1.1] tracking-tight md:text-[5.04rem]">
      ...
      <section className="mx-auto max-w-3xl px-6 py-28 text-center md:py-36">
        ...
        <h2 className="mt-7 font-heading text-[2.52rem] font-medium text-[var(--forest-sage)] md:text-[3.36rem]">
      ...
      <section className="grid md:grid-cols-2">
        <div className="relative min-h-[70vh]">
          <Image src={VISION_PHOTO.barnLuxury} alt="Luxury barn reception" fill className={EDITORIAL_IMAGE} sizes="50vw" />
        </div>
        <div className="flex flex-col justify-center bg-[var(--linen)] px-10 py-20 md:px-16">
          ...
          <p className="mt-8 max-w-md text-base leading-[1.7] text-[var(--forest-sage)]/75">
            Then Hello to Cheers proves it is not another point solution — because one inquiry already
          ...
          {VISION.operations.map((op, i) => (
            ...
            >
              <div className={`relative aspect-[4/5] ${EDITORIAL_FRAME}`}>
                <Image src={op.photo} alt={op.title} fill className={EDITORIAL_IMAGE} sizes="(max-width:768px) 100vw, 50vw" />
              </div>
              <div>
      ...
      <section className="bg-[var(--heritage-sage)] px-6 py-28 text-[var(--true-white)] md:py-36">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <h2 className="mt-7 font-heading text-[2.52rem] font-medium md:text-[4.2rem]">{VISION.triad.headline}</h2>
          ...
          <div className="mt-16 grid gap-10 md:grid-cols-3">
            {VISION.triad.parties.map((p) => (
              <div key={p.name} className="border-t border-white/25 pt-6 text-left">
                ...
                <p className="mt-3 text-sm leading-[1.7] text-white/70">{p.line}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* Guest + Luv editorial */}
      <section className="mx-auto grid max-w-6xl gap-16 px-6 py-28 md:grid-cols-2 md:py-36">
        <div>
          <p className="font-script text-3xl text-[var(--heritage-sage)]">
            {VISION.guestExperience.script}
          </p>
          <h2 className="mt-3 font-heading text-[2.1rem] text-[var(--forest-sage)] md:text-[2.52rem]">
            {VISION.guestExperience.headline}
          </h2>
          <p className="mt-5 text-base leading-[1.7] text-[var(--forest-sage)]/75">
            {VISION.guestExperience.body}
          </p>
          <div className={`relative mt-8 aspect-[5/4] ${EDITORIAL_FRAME}`}>
            <Image src={VISION_PHOTO.greenhouse} alt="Glass greenhouse venue" fill className={EDITORIAL_IMAGE} sizes="50vw" />
          </div>
        </div>
        <div>
          <p className="text-xs tracking-[0.28em] uppercase text-[var(--heritage-sage)]">
          ...
          <div className="mt-5 space-y-3 text-base leading-[1.7] text-[var(--forest-sage)]/75">
            <p>{VISION.luv.body}</p>
          ...
          <div className="mt-8">
            <ProductMoment label="Luv · thoughtful recommendations" />
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-3xl px-6 py-28 text-center md:py-36">
        ...
        <h2 className="mt-14 font-heading text-[2.52rem] text-[var(--forest-sage)]">{VISION.cta.headline}</h2>
