  ...
  return (
    <div className="bg-[var(--forest-sage)] text-[var(--true-white)]">
      ...
      <section className="relative min-h-[100svh]">
        <Image src={VISION_PHOTO.coastal} alt="Coastal venue" fill className={EDITORIAL_IMAGE} sizes="100vw" />
      ...
      <section className="flex min-h-[100svh] flex-col justify-center px-6">
        <div className="mx-auto max-w-4xl">
          ...
          <h2 className="mt-8 font-heading text-[3.36rem] font-medium leading-[1.1] md:text-[5.04rem]">
      ...
      <section className="flex min-h-[100svh] flex-col justify-center bg-[var(--heritage-sage)] px-4 py-20 md:px-10">
        ...
        <div className={`mx-auto w-full max-w-6xl ${EDITORIAL_FRAME}`}>
          <div className="relative aspect-[16/10] w-full">
            <Image
              src={VISION_PHOTO.dashboard}
              alt="Hello to Cheers product"
              fill
      ...
      {VISION.operations.slice(0, 5).map((op) => (
        <section key={op.id} className="grid min-h-[100svh] md:grid-cols-2">
          <div className="relative min-h-[50vh] md:min-h-full">
            <Image src={op.photo} alt={op.title} fill className={EDITORIAL_IMAGE} sizes="50vw" />
          </div>
          <div className="flex flex-col justify-center px-8 py-16 md:px-16">
            ...
            <h2 className="mt-4 font-heading text-[2.52rem] font-medium leading-[1.05] md:text-[3.36rem]">
              {op.value}
            </h2>
      ...
      <section className="grid min-h-[100svh] bg-[var(--natural-cream)] text-[var(--forest-sage)] md:grid-cols-2">
        <div className="flex flex-col justify-center px-8 py-20 md:px-16">
          ...
          <h2 className="mt-4 font-heading text-[2.52rem] font-medium md:text-[4.2rem]">{VISION.luv.headline}</h2>
          <div className="mt-6 max-w-md space-y-3 text-base leading-[1.7] text-[var(--forest-sage)]/75">
            <p>{VISION.luv.body}</p>
      ...
      <section className="flex min-h-[90svh] flex-col items-center justify-center px-6 text-center">
        ...
        <h2 className="mt-16 font-heading text-[2.52rem] md:text-[3.36rem]">{VISION.cta.headline}</h2>
