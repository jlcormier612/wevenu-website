/**
 * Premium rustic-elegant stills for independent venues.
 * Barns, farms, inns, gardens, gazebos — muted greens, cream, beige, dusty rose.
 * No restaurants, catering plating, modern luxury homes, or saturated blues.
 * Product screenshots remain UiPlaceholder until Jen provides captures.
 */
...
export const FILM = {
  ...
  // Inquiry — first look (clear faces, muted neutrals — no flare)
  propertyWalk:
    "https://images.unsplash.com/photo-1484849559669-ceae3b12a437?auto=format&fit=crop&w=1600&q=80",

  // Tour — garden path
  gardenPath:
    "https://images.unsplash.com/photo-1511285560929-80b456fea0bc?auto=format&fit=crop&w=1800&q=80",

  // Proposal — stationery mood (no venue)
  paperLuxury:
    "https://images.unsplash.com/photo-1450101499163-c8848c66ca85?auto=format&fit=crop&w=1400&q=80",

  // Planning — florals & rustic table detail
  floralsSoft:
